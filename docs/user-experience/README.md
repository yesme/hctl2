...
> 状态：用户体验基线；本轮组织结构、行为选择与原文核对均已确认，正式规范尚待对齐，不是实现完成报告。<br>
> 整理日期：2026-09-19<br>
...
| 术语混用说明 | [03 · 术语纠正](./03-terminology-confession.md#project--repo--topic-混用的-confession) | 保留原话，说明新旧含义、尚未对齐的位置与记录退役条件 |
...
[已定事项与接手清单](./open-questions.md#已定事项与接手清单)记录 Q1–Q3、C1 的确认结论和设计者的后续工作，这四项无需重拍。后续体验补充另按所有者确认更新，不让接手者靠恢复聊天记录继续。
...
| 来源 | 在本目录中的处理 |
| --- | --- |
| 所有者原始[HCTL 案例](../../.memo/notes/HCTL_case_study.md#hctl案例)，2026-09-06；后续补充至 09-13 | 01 保留 S1.1–S1.11、S1.N1–S1.N8 与共享/独立克隆两种布局；按已澄清的含义整理分组名称，cloud 两处主 Room 的位置已由所有者确认 |
