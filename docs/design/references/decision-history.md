...
| v0.17.2 | 2026-09-10 | 三组研究落设计正文（治理功能消亡 33 家、多 agent 协作有效性、Prove2Me 依赖图）：愿景补「中段判断门无人守住」的行业证据与「省」的标尺、自举是门在工作的唯一证明；Run 正文重写评审独立性（多样性三层、人设不算、同配置同包只算一票、分歧不设商量回合）并新增「施工图怎么凝结」（节点判据二选一、边由机械物承载、盲读回默认开、运行中不归约子节点）；Participant 正文收窄专业化说法（Skill 改上下文、人设是界面属性）；Context、Project、Task 正文各补一句；交付默认值返工上限改 2 轮、自举加门触发计数与逃生口验收；Run 正文写施工图归约的七条抑制规则与关键路径度量；Participant 模型重排——工种（Agency 名册）→ 选进 Room 的规划者 / 选进 Run 席位的施工者 → 执行体，撤销「参与者授权」与 Participant–Agency Binding，系统角色名 worker 改执行体；不改约束语义 | [裁决记录](../../../.memo/design/design-review-20260902/21-r2-rulings.md) |
