...
| v0.18.8 | 2026-09-19 | G 批第 2 批（全库对照 v0.18.7 核对，施工图来源族与「哪份 Git」族）：施工图可由 Room 讨论凝结或从 Task 模板填表而来，版本、批准与 Task 关联归 Run；结晶归属按实际来源判断；判决权威在治理记录、审计副本在治理材料、公开范围不随仓库隐私推定；读回规则在确无来源 Room 时只有该 Room 名册回避项不适用，其余隔离与可核条件保留，配正反例（所有者 2026-09-19 裁 A5）；不改其他约束 | [G 批方案 §八](../../../.memo/design/case-study-20260907/16-batch-g-plan.md) · #待补 |
