...
| v0.18.9 | 2026-09-19 | G 批第 3a 批（全库对照 v0.18.7 核对，语义范围族与单元）：承诺、授权与验收以 Project 为范围，Repo 级代码与平台事实仍按 Repo 管理（所有者 2026-09-19 裁 A1）；Project 不是部署单元，共享资源不合并归属与授权；引用保留对象既有作用域；备份只含控制面自己的定义与 Skill 引用；Attempt 切换只在 Agency 报无法履约后；文档纪律加体验目录一条；#263 三条原则的三处落点（愿景入口原则、组织层可观测、承诺成本入总账）；不改其他约束 | [G 批方案 §八](../../../.memo/design/case-study-20260907/16-batch-g-plan.md) · [#263 备忘](../../../.memo/design/intent-entry-principles-20260919.md) · #265 |
