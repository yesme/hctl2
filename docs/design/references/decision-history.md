...
> 状态：Informative · 对应草案 v0.9.0 · 2026-08-19<br>
...
这条来时路最终收敛为四个权威模块、四个对仗 Scene、共享但受控的连接与执行机制。阅读当前设计时，应从[愿景](../vision.md)开始，再读 [Project](../project.md)、[Task](../task.md)、[Run](../run.md)、[Harness](../harness.md)，再查看[连接合同](../connections.md)、[系统边界](../system.md)和[第一阶段交付](../delivery.md)。本文用于解释这些边界为什么存在；发生冲突时，它不覆盖任何当前规范。
