...
> 状态：Informative · 对应草案 v0.18.1 · 2026-09-13<br>
...
| B 系统边界与 Participant | Agency 非端点独占、信任边界与本机代管、`hctl2-tool` 部署位置与报告通道；系统权威地图的「一人多机连同一控制面存储」口径；工种接受条件、参与者侧待命定位、证据三档及 R2、失联 / 截止 / 身份不可证三分、权限分层、派工与恢复 |
