...
| v0.18.11 | 2026-09-19 | G 批第 4 批（全库对照 v0.18.7 核对，Overview 与归档恢复）：Project Overview 保留为只读投影、不要求独立入口、不替代主 Room 与「待你处理」（所有者 2026-09-19 裁 A3）；「需要关注」是对象标记，不另成待办；Topic Room 命令词「创建 / 关闭」，关闭即已归档；Project 恢复后随归档转只读的开放对象恢复接收命令、已终态不复活、已关闭 Topic 不随恢复；引用 Run 不改其授权、不承担交付，配 CT；不改其他约束 | [G 批方案 §八](../../../.memo/design/case-study-20260907/16-batch-g-plan.md) · #<PR 号> |
