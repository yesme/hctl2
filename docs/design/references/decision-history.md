...
> 状态：Informative · 对应草案 v0.18.0 · 2026-09-13<br>
...
| 批 | 未完成范围 |
| --- | --- |
| C Repo 与治理正文 | Repo 现场引用与身份、引用不相交、跨控制面平台仲裁、推送与发布评审分开、审计关联；治理记录与正文两半、材料存储与备份、Context 交付及 #216 F4 既列残留；「治理正文」词汇表行回补 |
