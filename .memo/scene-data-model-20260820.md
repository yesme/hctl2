...
> 状态：数据模型方向已获所有者认可；落入 design doc 的方式（术语、架构、选型三类改造）待专门讨论。关联：[room-ground-truth-20260819](./room-ground-truth-20260819.md)、[design-doc-method-20260819](./design-doc-method-20260819.md)。
