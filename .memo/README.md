...
| `design/scm-module-20260906/` | 待所有者拍板（v5，PR #184 不自合）· 第五模块（代码变更与集成）方案：四家评论已汇总，命名一致 Repo / Change，Write Lease、发布授权、结晶归属、目标头策略四项各家一致且已按意见收窄，决策史标题形式三比一分歧；GitHub 缺省且本批只做它已拍板；流程见目录 README |
