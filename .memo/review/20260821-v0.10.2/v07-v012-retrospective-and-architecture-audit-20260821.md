...
> 状态：已落地：decision-history §16 缺口审计（v0.12.0）；其五个新机制中两项后被 v0.13.0 §22 撤回<br>
> 基线：729238e → 367ac3f（草案 v0.7.0 → v0.12.0）<br>
> 去向：decision-history §16<br>
> 日期：2026-08-21<br>
> 说明：Informative；记录历史理解、架构评价、本轮问题与修复，不覆盖 `docs/design/` 的规范。<br>
