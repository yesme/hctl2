...
| G 批：全库对照 v0.18.7 核对 | 方案 v1 待四席三层审（Codex、Grok、GLM、K3）· 所有者 09-19「归档，然后开 G 批」；判据：#257 体验目录、四个视角（Unit / Module / 对象归属 / 用户导航）、#261 抽查；#251 与 Grok Bot 对照只作「含混要确定」的判据；清点表 76 行（六组走查、逐条 grep 核）、待裁 A 档 4 项 / B 档 6 项；拍板后按层三个修正 PR | #262、[16-batch-g-plan](./16-batch-g-plan.md) |
