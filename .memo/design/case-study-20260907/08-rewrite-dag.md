...
| F 批：Project 与 Task 解耦 | 方案 v1 独审中 · 四席 Codex、Grok、GLM、K3；首个带「先审题」节、三层审的方案；所有者树状图（控制面起点、仓库闭包、<控制面, 仓库> 沙箱对、Project/Task/Run 平权视图）为前提 | #246、[15-batch-f-plan](./15-batch-f-plan.md) |
