...
**尚未定形**（在对应批次的方案里定，不进图）：B 批待命与会话复用写不写进设计正文；D 批施工图 lint 去重检查里哪部分能静态判；P2.1 何时开工。（F1/R1/R3 随 R 批 #220 拍板、§37 行文随 A 批 #223 已定，2026-09-14 删。）
...
| B P.1–P.7 | 进行中 · P.1–P.6 完成（Muse 一次读回）；2026-09-14 裁决到达（节点 X，「裁决 · B 批 · 第一次」），四家做「代理原则核查」，v4 按裁决重写；待 Muse 第二次读回、P.7 | [12-batch-b-plan.md](./12-batch-b-plan.md)；#228 |
| B W.1–W.4 | 未开始 | |
| D P.1–P.7 | 未开始 | |
| D W.1–W.4 | 未开始 | |
