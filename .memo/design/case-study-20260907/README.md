...
> 状态：讨论中 · 两轮审阅完成；§九 三处里用例修改与"账本"禁用已落（#195、#194），第 13 条治理正文的裁决建议在 `03-governance-text.md` v2（Codex 审后 Fable 改口），待所有者拍板<br>
...
| `03-governance-text.md` | Fable | 第 13 条治理正文放哪（v2）：参与者读任务书靠冻结输入、实际交付、保留与可再取；收敛的形状；裁决建议改口为缺省独立治理材料仓库、旁路 ref 为显式选项；审计关联、备份恢复、第三种办法；待拍板三处 |
