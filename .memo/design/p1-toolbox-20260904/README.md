...
| 乙 | 封存、保全、拆除 | Grok | 进行中（PR #177 复审两项修正已落实，待再审） | PR #177：gitlink 须磁盘上真有仓库；丢弃预览含 `nested_repositories` | 2026-09-05 |
...
| #177 | [推翻 R1–R3 + 3 项修正](https://github.com/yesme/hctl2/pull/177#issuecomment-5549742219)；[复审两项修正](https://github.com/yesme/hctl2/pull/177#issuecomment-5549885751) | [修正 A/B](https://github.com/yesme/hctl2/pull/177#issuecomment-5549727741)；[复审通过](https://github.com/yesme/hctl2/pull/177#issuecomment-5549883476) | 第一轮修正已落实；复审两项（未初始化子模块误判、丢弃预览缺嵌套仓库）已改，待再审 |
