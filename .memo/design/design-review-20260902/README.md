...
> 状态：第三轮进行中——批 1（写法）、批 2（约束）、批 3（愿景与架构）已合入 main（v0.16.3）；批 4 写作规则机械化、批 5 部件与代码、批 6 研究层追加与评审 Skill 待分派，任务书见 `30-r3-remaining-brief.md`<br>
...
| 3.4 写作规则机械化 | 待分派 | `30-r3-remaining-brief.md` §批 4 | — |
| 3.5 部件与代码 | 待分派 | `30-r3-remaining-brief.md` §批 5 | — |
| 3.6 研究层追加与评审 Skill 抽取 | 待分派 | `30-r3-remaining-brief.md` §批 6 | — |
