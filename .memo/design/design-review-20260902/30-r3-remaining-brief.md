...
> 状态：任务书一已落（PR #153，v0.16.4；补充裁决 #154），任务书二已落（PR 甲 #156、PR 乙 #159），任务书三待开工（2026-09-04）<br>
...
1. 文档工具链：为四个检查器造误报与漏报样例（中文子串边界、代码体内的名字、豁免表、首现对照在表格里等），补进各检查器的测试；核对 PR 门阈值对重命名文件、移动文件的行为。
